...
Update mc.cores options to set specific number of cores to use for parallelizing the pairwise sequence 
alignment. The default recommended number of cores is one less than the total number of cores on the system. 
